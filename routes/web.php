...
// votes
Route::post('/questions/{question}/vote', 'VotesController@voteQuestion')->name('question.vote');
Route::post('/answers/{answer}/vote', 'VotesController@voteAnswer')->name('answer.vote');
